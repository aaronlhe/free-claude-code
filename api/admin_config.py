...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        secret=True,
        description=(
            "Azure OpenAI API key (optional; leave blank to use Azure Default Credentials)."
        ),
    ),
    ConfigFieldSpec(
        ...
        "providers",
        settings_attr="azure_openai_endpoint",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        settings_attr="azure_openai_deployment",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        settings_attr="azure_openai_api_version",
    ...
    ConfigFieldSpec(
        ...
        "Azure OpenAI Scope",
        "providers",
        settings_attr="azure_openai_scope",
        default="https://cognitiveservices.azure.com/.default",
        description="Azure AD token scope for DefaultAzureCredential auth.",
        advanced=True,
    ),
    ConfigFieldSpec(
        "LM_STUDIO_BASE_URL",
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="azure_openai_proxy",
        secret=True,
        advanced=True,
    ),
    ConfigFieldSpec(
